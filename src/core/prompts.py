...
*   **Estructura "Fuentes y Jurisprudencia"**:
    ...
    *   **PARA FUENTES INTERNAS RAG (Tus PDFs):** Utiliza **EXCLUSIVAMENTE** la metadata proporcionada. El formato a usar es: `**Fuente:** **<Título de la metadata>, <Autor de la metadata>**`. Debajo, escribe `**Texto:**` seguido de un bloque de cita (`>`) con un párrafo sustancial y completo extraído del contenido del documento. **No inventes títulos o autores.**
