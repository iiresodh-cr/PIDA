...
# Importa el nuevo cliente de Firestore
...
# Esto permite que tu frontend en pida.iiresodh.org pueda comunicarse con este backend.
origins = [
...
async def stream_chat_response_generator(chat_request: ChatRequest, country_code: str | None):
    ...
    try:
        ...
        # Quitamos el último mensaje (el que acaba de enviar el usuario) para no duplicarlo en el historial
